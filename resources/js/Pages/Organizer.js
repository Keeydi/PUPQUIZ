...
const Form = (props) => {
    ...
    return (_jsxs("div", {
        ...
        children: [_jsxs("div", {
            ...
            children: [_jsx("div", {
                className: "w-[100%] lg:w-[100%] mx-auto  lg:mb-6 mt-4 lg:mt-6",
                children: _jsx("div", {
                    className: "w-full h-2 rounded-full bg-transparent",
                    children: _jsx("div", {
                ...
                children: [_jsx("h2", {
                    ...
                    children: [steps[currentStep].fields.map((field) => (_jsxs("div", {
                        className: "relative",
                        children: [_jsx("label", {
                    ...
                    }, field.name))), _jsxs("div", {
                        className: "flex justify-between pt-8",
                        children: [currentStep > 0 && (_jsx("button", {
                            type: "button",
                            ...
                            children: currentStep === steps.length - 1 ? "Sign Up" : "Continue"
                        })]
                    })]
                })]
            })]
